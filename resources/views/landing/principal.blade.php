    ...
    <div class="slide-home-01">
        <div class="response-product product-list-owl owl-slick equal-container better-height"
            ...
            <div class="slide-wrap">
                <img src="assets/images/scb1.png" alt="image">
            ...
            <div class="slide-wrap">
                <img src="assets/images/scb2.png" alt="image">
                <div class="slide-info">
                    <div class="container">
                        <div class="slide-inner">
                        ...
                        <div class="banner-inner">
                            ...
                            <div class="banner-info ">
                                <div class="banner-content">
                                    <div class="">
                                        <h6 class="title" style="margin-top: 200px;">
                                            <p style="color: #ad296d;">Conoce la magia de la Naturaleza a través de nuestros productos Artesanales creados para ti</p>
                                        </h6>
                                    </div>
        ...
        <div class="container">
            <div class="akasha-heading style-01">
                <div class="heading-inner">
                    <h3 class="title">Ùltimos Productos</h3>
                    ...
                    <div class="banner-content">
                        <div class="title-wrap">
                            <div class="banner-label">
                                Cremas de dia y de noche
                            </div>
                            <h6 class="title">
                                Full Colàgeno </h6>
                                <h6 class="title">
                                Acido Hialuronico</h6>
                        </div>
                        <div class="button-wrap">
                            <div class="subtitle">
                            </div>
                            <a class="button" target="_blank" href="#"><span>Ver Catalogo</span></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="section-001">
        <div class="container">
            <div class="akasha-heading style-01">
                <div class="heading-inner">
                    <h3 class="title">
                    SÌGUENOS EN INSTAGRAM</h3>
                    <div class="subtitle">
                      @ganeshas.pe
                    </div>
                    <div class="subtitle">
                    Y ¡hagamos nuestros sueños juntas realidad!
                    </div>
                </div>
            </div>
