...
-->
  ...
  <body>
    ...
    <div class="best-features">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12" style="text-align: center;">
            <div>
              <p style="font-size: 15px;margin-top:30px;">Descubre en nuestro Catálogo los conocimientos de la sabiduría ancestral de los pueblos indígenas a través de nuestros productos creados desde sus secretos místicos, formas de elaboración, fórmulas y la magia curativa de plantas medicinales, cristales, piedras o cuarzos! </p>
            </div>
          </div>
    ...
    <div class="row" style="margin-top: -50px;">
            <img src="segunda.jpg" alt="" style=" display: block;
                    margin-left: auto;
                    margin-right: auto;
                    width: 40%; height: 50%;">
          </div>
