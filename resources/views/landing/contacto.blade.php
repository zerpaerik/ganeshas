...
-->
  ...
  <body>
            ...
            <div class="contact-form">
              <form id="contact" action="" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="email" type="text" class="form-control" id="email" placeholder="DNI / C.E.:" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="subject" type="date" class="form-control" id="subject" placeholder="Fecha de Nacimiento:" required="">
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="message" rows="6" class="form-control" id="message" placeholder="Dirección:" required=""></textarea>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="message" rows="6" class="form-control" id="message" placeholder="Teléfono de contacto:" required=""></textarea>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="filled-button" style="background-color:#ad296d">Enviar</button>
                    </fieldset>
                  </div>
                </div>
              </form>
    ...
    <footer style="background-color:#ad296d;margin-top: 20px;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
